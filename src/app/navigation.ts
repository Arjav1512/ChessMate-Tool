...
export const PRIMARY_NAV: NavDestination[] = [
  { key: 'dashboard', label: 'Dashboard', glyph: '◉', path: '/dashboard', flag: 'ui.screen.dashboard', phase: 4, purpose: 'Orientation + momentum. How am I doing / what next?' },
  { key: 'games', label: 'Games', glyph: '▦', path: '/games', flag: 'ui.screen.games', phase: 7, purpose: 'Manage & locate every imported game.' },
  { key: 'analysis', label: 'Analysis', glyph: '◎', path: '/analysis', flag: 'ui.screen.analysis', phase: 5, purpose: 'Understand a single game move-by-move.' },
  { key: 'improve', label: 'Improve', glyph: '▲', path: '/improve', flag: 'ui.screen.improve', phase: 6, purpose: 'Weaknesses → plan → milestones.' },
  { key: 'coach', label: 'Coach', glyph: '✦', path: '/coach', flag: 'ui.screen.coach', phase: 8, purpose: 'On-demand guided explanation & review.' },
];
...
export const USER_MENU: NavDestination[] = [
  { key: 'profile', label: 'Profile', glyph: '◯', path: '/profile', flag: 'ui.screen.profile', phase: 10, purpose: 'Identity, rating, history, achievements.' },
  { key: 'settings', label: 'Settings', glyph: '⚙', path: '/settings', flag: 'ui.screen.settings', phase: 10, purpose: 'Account, platforms, analysis depth, appearance.' },
];

/** Sub-views within Improve (§3) — reachable inside Improve + via ⌘K, not primary nav. */
export const IMPROVE_SUBVIEWS: NavDestination[] = [
  { key: 'weaknesses', label: 'Weakness Profile', glyph: '◍', path: '/weaknesses', flag: 'ui.screen.weaknesses', phase: 9, purpose: 'Deep view of recurring weaknesses by rating impact.' },
  { key: 'progress', label: 'Progress', glyph: '↗', path: '/progress', flag: 'ui.screen.progress', phase: 9, purpose: 'Make improvement felt over time.' },
];

/** Owned route off Games (§3) — import flow. */
export const IMPORT_ROUTE: NavDestination = { key: 'import', label: 'Import games', glyph: '⊕', path: '/games/import', flag: 'ui.screen.games', phase: 7, purpose: 'Get games in with zero friction.' };
