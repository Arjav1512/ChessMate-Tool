...
| AUD-09 | 🟡 IN PROGRESS | UI / DS | Inline-style sprawl (639 literals, ~70 ad-hoc buttons) duplicating the existing design system | Inconsistency, drift, maintenance | **P0 done (PR #14):** Button primitive completed + adopted; audit+plan in `DESIGN_SYSTEM_AUDIT.md`. P1–P3 autonomous; **P4 (header/landing/GameViewer) needs visual QA** | L |
