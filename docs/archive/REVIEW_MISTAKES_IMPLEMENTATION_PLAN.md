...
> **Authority:** `CHESSMATE_SYSTEM_DESIGN.md` §8/§9/§4.7 (mistake-review functionality is distributed; no standalone screen) · Architecture §4/§5/§7/§12. Input: `REVIEW_MISTAKES_DISCOVERY.md`. Documentation wins.
